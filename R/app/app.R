...
occurencesPanel <- function() {
    tabPanel(title = "Occurences",
        tags$head(tags$link(rel = "stylesheet", href="https://unpkg.com/leaflet@1.9.1/dist/leaflet.css", integrity="sha256-sA+zWATbFveLLNqWO2gtiw3HL/lh1giY/Inf1BJ0z14=", crossorigin="")),
        tags$head(tags$script(src = "https://unpkg.com/leaflet@1.9.1/dist/leaflet.js", integrity="sha256-NDI0K41gVbWqfkkaHj15IzU7PtMoelkzyKp8TOaFQ3s=", crossorigin="")),
        tags$head(tags$link(rel = "stylesheet", href = "https://unpkg.com/@geoman-io/leaflet-geoman-free@latest/dist/leaflet-geoman.css")),
        tags$head(tags$script(src = "https://unpkg.com/@geoman-io/leaflet-geoman-free@latest/dist/leaflet-geoman.min.js")),
        tags$div(id = "map", style = "height: 400px;"),
